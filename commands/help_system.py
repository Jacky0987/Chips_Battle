...
🏢 公司管理中心:
  company                              - 进入公司管理系统主菜单
  company list                         - 查看市场上所有公司
  company create <名称> <行业> [描述]    - 创建新公司

👨‍💼 我的公司:
  company my                           - 查看我拥有的公司
  company info <公司ID或股票代码>        - 查看公司详细信息
  company news <公司ID>                - 查看公司新闻事件

💹 IPO上市:
  company ipo <公司ID> <发行价> <股数>   - 申请公司IPO上市

🚀 公司发展:
  company develop <公司ID> <发展类型>    - 投资公司发展
  company industry <行业名>            - 查看行业分析报告
...
💰 使用示例:
  company create "科技创新" technology "专注AI技术研发"
  company develop TECH_001 research        - 对TECH_001进行研发投资
  company ipo TECH_001 50.0 1000000       - TECH_001以50元/股发行100万股上市
  company industry technology             - 查看科技行业分析报告
